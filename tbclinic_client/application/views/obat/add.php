        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="pembuat_obat" class="col-sm-2 col-form-label">Apoteker</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="pembuat_obat" name="pembuat_obat" rows="3"><?= set_value('pembuat_obat'); ?></textarea>
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        <label for="stok_obat" class="col-sm-2 col-form-label">Stok</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="stok_obat" name="stok_obat" rows="3"><?= set_value('stok_obat'); ?></textarea>
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="date" class="form-control" id="tanggal_kadaluarsa" name="tanggal_kadaluarsa" value="<?= set_value('tanggal_kadaluarsa'); ?>">
                            <small class="text-danger">
